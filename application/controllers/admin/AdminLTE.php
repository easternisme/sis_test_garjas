<?php
	...
	class AdminLTE extends CI_Controller {
		...
		public function dashboard(){
			$this->load->view('admin/adminlte/layout/index');
		}

		public function dashboard2(){
			$this->load->view('admin/adminlte/layout/index-2');
		}
		public function dashboard3(){
			$this->load->view('admin/adminlte/layout/index-3');
		}

		public function dashboard4(){
			$this->load->view('admin/adminlte/layout/index-4');
		}
