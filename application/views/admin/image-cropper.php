...
<head>
    ...
    <!-- cropper CSS
		============================================ -->
    <link rel="stylesheet" href="<?= base_url() ?>public/asset/css/cropper/cropper.min.css">
    <!-- main CSS
		============================================ -->
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="image-crop">
                                    <img src="<?= base_url() ?>public/asset/img/cropper/1.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <!-- cropper JS
		============================================ -->
    <script src="<?= base_url() ?>public/asset/js/cropper/cropper.min.js"></script>
    <script src="<?= base_url() ?>public/asset/js/cropper/cropper-actice.js"></script>
    <!--  wave JS
		============================================ -->
