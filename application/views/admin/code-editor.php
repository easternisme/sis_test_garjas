...
<head>
    ...
    <!-- codemirror CSS
		============================================ -->
    <link rel="stylesheet" href="<?= base_url() ?>public/asset/css/code-editor/codemirror.css">
    <link rel="stylesheet" href="<?= base_url() ?>public/asset/css/code-editor/ambiance.css">
    <!-- main CSS
		============================================ -->
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <!-- code editor JS
		============================================ -->
    <script src="<?= base_url() ?>public/asset/js/code-editor/codemirror.js"></script>
    <script src="<?= base_url() ?>public/asset/js/code-editor/code-editor.js"></script>
    <script src="<?= base_url() ?>public/asset/js/code-editor/code-editor-active.js"></script>
    <!--  Chat JS
		============================================ -->
