...
<head>
    ...
    <title>Tabs | Notika - Notika Admin Template</title>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>public/asset/css/wave/button.css">
    <!-- main CSS
		============================================ -->
                    ...
                    <div class="widget-tabs-int">
                        ...
                        <div class="widget-tabs-list">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#home">Tab Menu 1</a></li>
                                <li><a data-toggle="tab" href="#menu1">Tab Menu 2</a></li>
                    ...
                    <div class="widget-tabs-int tab-ctm-wp mg-t-30">
                        ...
                        <div class="widget-tabs-list">
                            <ul class="nav nav-tabs tab-nav-right">
                                <li class="active"><a data-toggle="tab" href="#home2">Tab Menu 1</a></li>
                                <li><a data-toggle="tab" href="#menu12">Tab Menu 2</a></li>
                                <li><a data-toggle="tab" href="#menu22">Tab Menu 3</a></li>
                            </ul>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="widget-tabs-int mg-t-30">
                        <div class="tab-hd">
                            ...
                            <p>You may add optional animation classes to animate the tab panes when switching. Please refer the Animations page to get all the available classes <a target="_blank" href="https://daneden.github.io/animate.<?= base_url() ?>public/asset/css/">Click Here</a>.</p>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="widget-tabs-list tab-pt-mg">
                                    <ul class="nav nav-tabs tab-nav-center">
                                        <li class="active"><a data-toggle="tab" href="#home3">Tab Menu 1</a></li>
                                        <li><a data-toggle="tab" href="#menu13">Tab Menu 2</a></li>
                                        <li><a data-toggle="tab" href="#menu23">Tab Menu 3</a></li>
                                    </ul>
                                    <div class="tab-content tab-custom-st">
                                        <div id="home3" class="tab-pane in active animated zoomInLeft">
                                            <div class="tab-ctn">
                                                <p>Duis arcu tortor, suscipit eget, imperdiet nec, imperdiet iaculis, ipsum. Vestibulum of purus quam, scelerisque ut, mollis sed, nonummy id, metus. Nulla sit amet este. Praesent ac massa at ligula laoreet iaculis. Vivamus aliquet elit ac nisl. Nulla theportan dolor. Cras dapibus. Aliquam lorem ante, dapibus in, viverra quy, crydesfeugiat a, tellus.</p>
                            ...
                            <div class="col-lg-6">
                                <div class="widget-tabs-list tab-pt-mg sm-res-mg-t-30 tb-res-mg-t-30">
                                    <ul class="nav nav-tabs tab-nav-center">
                                        <li class="active"><a data-toggle="tab" href="#home4">Tab Menu 1</a></li>
                                        <li><a data-toggle="tab" href="#menu14">Tab Menu 2</a></li>
                                        <li><a data-toggle="tab" href="#menu24">Tab Menu 3</a></li>
                                    </ul>
                                    <div class="tab-content tab-custom-st">
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <!-- flot JS
		============================================ -->
    <script src="<?= base_url() ?>public/asset/js/flot/flot-widget-anatic-active.js"></script>
    <script src="<?= base_url() ?>public/asset/js/flot/chart-tooltips.js"></script>
