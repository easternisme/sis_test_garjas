            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="recent-signup-inner notika-shadow mg-t-30">
                        ...
                        <div class="widget-signup-list">
                            <a class="signup-wd-mn" data-toggle="tooltip" data-placement="top" title="John Deo" href="#"><img src="<?= base_url() ?>public/asset/img/post/1.jpg" alt="" /></a>
                            ...
                            <a class="signup-wd-mn" data-toggle="tooltip" data-placement="top" title="Smith" href="#"><img src="<?= base_url() ?>public/asset/img/post/2.jpg" alt="" /></a>
                            ...
                            <a data-toggle="tooltip" data-placement="top" title="John Deo" href="#"><img src="<?= base_url() ?>public/asset/img/post/1.jpg" alt="" /></a>
                            <a data-toggle="tooltip" data-placement="top" title="Malika" href="#"><img src="<?= base_url() ?>public/asset/img/post/4.jpg" alt="" /></a>
                            ...
                            <a data-toggle="tooltip" data-placement="top" title="Smith" href="#"><img src="<?= base_url() ?>public/asset/img/post/2.jpg" alt="" /></a>
                            ...
                            <a class="widgets-mg-sn" data-toggle="tooltip" data-placement="top" title="John Deo" href="#"><img src="<?= base_url() ?>public/asset/img/post/1.jpg" alt="" /></a>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="blog-inner-list notika-shadow mg-t-30 tb-res-ds-n dk-res-ds">
                        <div class="blog-img">
                            <img src="<?= base_url() ?>public/asset/img/blog/1.jpg" alt="" />
                        </div>
                        <div class="blog-ctn">
                            ...
                            <div class="tab-content">
                                <div id="home" class="tab-pane fade in active">
                                    <div class="tab-wd-img">
                                        <img src="<?= base_url() ?>public/asset/img/widgets/6.png" alt="" />
                                    </div>
                                    <div class="tab-ctn">
                                ...
                                <div id="menu1" class="tab-pane fade">
                                    <div class="tab-wd-img">
                                        <img src="<?= base_url() ?>public/asset/img/widgets/2.png" alt="" />
                                    </div>
                                    <div class="tab-ctn">
                                        <p>Serhoncus quis est sit amete in nisl molestie of fringilla. Nunc vitae ante magna feugiat condi. Serhoncus quis est cry int fly.</p>
                                        <ul class="tab-ctn-list">
                                ...
                                <div id="menu2" class="tab-pane fade">
                                    <div class="tab-wd-img">
                                        <img src="<?= base_url() ?>public/asset/img/widgets/4.png" alt="" />
                                    </div>
                                    <div class="tab-ctn">
                                        <p>Serhoncus quis est sit amete in nisl molestie of fringilla. Nunc vitae ante magna feugiat condi. Serhoncus quis est cry int fly.</p>
                                        <ul class="tab-ctn-list">
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <!-- Google map JS
		============================================ -->
    <script src="<?= base_url() ?>public/asset/js/google.maps/google.maps-active.js"></script>
