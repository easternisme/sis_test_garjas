                    ...
                    <div class="search-engine-int">
                        ...
                        <div class="search-eg-table">
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td><img class="search-engine-img" src="<?= base_url() ?>public/asset/img/search-engines/google.png" alt="">Google</td>
                                        <td class="text-right">3831 <i class="notika-icon notika-up-arrow"></i></td>
                                    </tr>
                                    <tr>
                                        <td><img class="search-engine-img" src="<?= base_url() ?>public/asset/img/search-engines/bing.png" alt="">Bing</td>
                                        <td class="text-right">2123 <i class="notika-icon notika-down-arrow"></i></td>
                                    </tr>
                                    <tr>
                                        <td><img class="search-engine-img" src="<?= base_url() ?>public/asset/img/search-engines/baidu.png" alt="">Baidu</td>
                                        <td class="text-right">4375 <i class="notika-icon notika-up-arrow"></i></td>
                                    </tr>
                                    <tr>
                                        <td><img class="search-engine-img" src="<?= base_url() ?>public/asset/img/search-engines/yahoo.png" alt="">Yahoo</td>
                                        <td class="text-right">4020 <i class="notika-icon notika-up-arrow"></i></td>
                                    </tr>
                                    <tr>
                                        <td><img class="search-engine-img" src="<?= base_url() ?>public/asset/img/search-engines/duckduckgo.png" alt="">DuckDuckGo</td>
                                        <td class="text-right">2064 <i class="notika-icon notika-up-arrow"></i></td>
                                    </tr>
                                    <tr>
                                        <td class="analysis-rd-mg"><img class="search-engine-img" src="<?= base_url() ?>public/asset/img/search-engines/yandex.png" alt="">Yandex</td>
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <script src="<?= base_url() ?>public/asset/js/flot/jquery.flot.time.js"></script>
    <script src="<?= base_url() ?>public/asset/js/flot/jquery.flot.tooltip.min.js"></script>
    <script src="<?= base_url() ?>public/asset/js/flot/analtic-flot-active.js"></script>
	<!--  wave JS
		============================================ -->
