...
<head>
    ...
    <!-- jvectormap CSS
		============================================ -->
    <link rel="stylesheet" href="<?= base_url() ?>public/asset/css/jvectormap/jquery-jvectormap-2.0.3.css">
    <!-- notika icon CSS
		============================================ -->
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="realtime-wrap notika-shadow mg-t-30">
                        ...
                        <div class="realtime-country-ctn realtime-ltd-mg">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="<?= base_url() ?>public/asset/img/country/1.png" alt="" /></span> <span>United States</span>
                                </div>
                        ...
                        <div class="realtime-country-ctn">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="<?= base_url() ?>public/asset/img/country/2.png" alt="" /></span> <span>Australia</span>
                                </div>
                                <div class="realtime-bw">
                                    <span>Firefox</span>
                                </div>
                        ...
                        <div class="realtime-country-ctn">
                            ...
                            <div class="realtime-ctn-bw">
                                <div class="realtime-ctn-st">
                                    <span><img src="<?= base_url() ?>public/asset/img/country/3.png" alt="" /></span> <span>Brazil</span>
                                </div>
                                <div class="realtime-bw">
                                    <span>Firefox</span>
                                </div>
                                    ...
                                    <ul class="conversation-list">
                                        <li class="clearfix">
                                            <div class="chat-avatar">
                                                <img src="<?= base_url() ?>public/asset/img/post/1.jpg" alt="male">
                                                <i>10:00</i>
                                            </div>
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="<?= base_url() ?>public/asset/img/post/2.jpg" alt="Female">
                                                <i>10:01</i>
                                            </div>
                                            <div class="conversation-text">
                                        ...
                                        <li class="clearfix odd">
                                            <div class="chat-avatar">
                                                <img src="<?= base_url() ?>public/asset/img/post/2.jpg" alt="male">
                                                <i>10:02</i>
                                            </div>
                                            <div class="conversation-text">
                                                <div class="ctext-wrap chat-widgets-cn">
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <!-- jvectormap JS
		============================================ -->
    <script src="<?= base_url() ?>public/asset/js/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="<?= base_url() ?>public/asset/js/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <script src="<?= base_url() ?>public/asset/js/jvectormap/jvectormap-active.js"></script>
    <!-- sparkline JS
		============================================ -->
    ...
    <script src="<?= base_url() ?>public/asset/js/flot/jquery.flot.pie.js"></script>
    <script src="<?= base_url() ?>public/asset/js/flot/jquery.flot.tooltip.min.js"></script>
    <script src="<?= base_url() ?>public/asset/js/flot/jquery.flot.orderBars.js"></script>
    <script src="<?= base_url() ?>public/asset/js/flot/curvedLines.js"></script>
    ...
    <!--  Chat JS
		============================================ -->
	<script src="<?= base_url() ?>public/asset/js/chat/moment.min.js"></script>
