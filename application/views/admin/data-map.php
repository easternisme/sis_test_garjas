...
<head>
    ...
    <!-- charts CSS
		============================================ -->
    <link rel="stylesheet" href="<?= base_url() ?>public/asset/css/c3/c3.min.css">
    <!-- main CSS
		============================================ -->
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <!-- Data Maps JS
		============================================ -->
    <script src="<?= base_url() ?>public/asset/js/data-map/d3.min.js"></script>
    <script src="<?= base_url() ?>public/asset/js/data-map/topojson.js"></script>
    <script src="<?= base_url() ?>public/asset/js/data-map/datamaps.all.min.js"></script>
    <script src="<?= base_url() ?>public/asset/js/data-map/data-maps-active.js"></script>
    <!-- main JS
		============================================ -->
