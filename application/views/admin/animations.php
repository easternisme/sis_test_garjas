...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>public/asset/css/animation/animation-custom.css">
    <!-- normalize CSS
		============================================ -->
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="animation-single-int">
                        ...
                        <div class="animation-img mg-b-15">
                            <img class="animate-one" src="<?= base_url() ?>public/asset/img/widgets/2.png" alt="" />
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="animation-single-int sm-res-mg-t-30">
                        ...
                        <div class="animation-img mg-b-15">
                            <img class="animate-two" src="<?= base_url() ?>public/asset/img/widgets/4.png" alt="" />
                        </div>
                        <div class="animation-action">
                            <div class="row">
                                <div class="col-lg-6">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="animation-single-int sm-res-mg-t-30">
                        ...
                        <div class="animation-img mg-b-15">
                            <img class="animate-three" src="<?= base_url() ?>public/asset/img/widgets/6.png" alt="" />
                        </div>
                        <div class="animation-action">
                            <div class="row">
                                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="animation-single-int mg-t-30">
                        ...
                        <div class="animation-img mg-b-15">
                            <img class="animate-four" src="<?= base_url() ?>public/asset/img/widgets/2.png" alt="" />
                        </div>
                        <div class="animation-action">
                            <div class="row">
                                <div class="col-lg-6">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mg-t-30">
                    <div class="animation-single-int">
                        ...
                        <div class="animation-img mg-b-15">
                            <img class="animate-five" src="<?= base_url() ?>public/asset/img/widgets/4.png" alt="" />
                        </div>
                        <div class="animation-action">
                            <div class="row">
                                <div class="col-lg-6">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mg-t-30">
                    <div class="animation-single-int">
                        ...
                        <div class="animation-img mg-b-15">
                            <img class="animate-six" src="<?= base_url() ?>public/asset/img/widgets/6.png" alt="" />
                        </div>
                        <div class="animation-action">
                            <div class="row">
                                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="animation-single-int mg-t-30">
                        ...
                        <div class="animation-img mg-b-15">
                            <img class="animate-seven" src="<?= base_url() ?>public/asset/img/widgets/2.png" alt="" />
                        </div>
                        <div class="animation-action">
                            <div class="row">
                                <div class="col-lg-6">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mg-t-30">
                    <div class="animation-single-int">
                        ...
                        <div class="animation-img mg-b-15">
                            <img class="animate-eight" src="<?= base_url() ?>public/asset/img/widgets/4.png" alt="" />
                        </div>
                        <div class="animation-action">
                            <div class="row">
                                <div class="col-lg-6">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mg-t-30">
                    <div class="animation-single-int">
                        ...
                        <div class="animation-img mg-b-15">
                            <img class="animate-nine" src="<?= base_url() ?>public/asset/img/widgets/6.png" alt="" />
                        </div>
                        <div class="animation-action">
                            <div class="row">
                                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="animation-single-int mg-t-30">
                        ...
                        <div class="animation-img mg-b-15">
                            <img class="animate-ten" src="<?= base_url() ?>public/asset/img/widgets/2.png" alt="" />
                        </div>
                        <div class="animation-action">
                            <div class="row">
                                <div class="col-lg-6">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mg-t-30">
                    <div class="animation-single-int">
                        ...
                        <div class="animation-img mg-b-15">
                            <img class="animate-eleven" src="<?= base_url() ?>public/asset/img/widgets/4.png" alt="" />
                        </div>
                        <div class="animation-action">
                            <div class="row">
                                <div class="col-lg-6">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mg-t-30">
                    <div class="animation-single-int">
                        ...
                        <div class="animation-img mg-b-15">
                            <img class="animate-twelve" src="<?= base_url() ?>public/asset/img/widgets/6.png" alt="" />
                        </div>
                        <div class="animation-action">
                            <div class="row">
                                <div class="col-lg-6">
